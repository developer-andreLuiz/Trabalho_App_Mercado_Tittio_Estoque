...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Trabalho_App_Mercado_Tittio_Estoque.Android.dll" comes first in this list. */
		"Trabalho_App_Mercado_Tittio_Estoque.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"Trabalho_App_Mercado_Tittio_Estoque.dll",
